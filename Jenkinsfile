			...
			try {
				withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: env.CI_DOCKER_HUB_CREDENTIAL_ID,
					...
					withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: env.CI_ARTIFACTORY_CREDENTIAL_ID,
						...
						stage ("install" ) {
							env.OCH_CLONEHERO_PATH = SecretsVault.get(this, "secret/${env.CI_PROJECT_NAME}", "OCH_CLONEHERO_PATH")
							env.OCH_LASTFM_LOOKUP = SecretsVault.get(this, "secret/${env.CI_PROJECT_NAME}", "OCH_LASTFM_LOOKUP")
